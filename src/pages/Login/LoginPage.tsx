...
const Login: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate a login request (You can replace it with actual API call)
    setTimeout(() => {
      alert('Logged in!');
      setIsSubmitting(false);
    }, 2000); // Simulating 2-second delay for login request
  };
      ...
      <div className="min-h-screen flex flex-col items-center justify-center">
        <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(13,149,92,0.3)] rounded-md">
          <div className="md:max-w-md w-full px-4 py-4">
            <form onSubmit={handleSubmit}>
              <div className="mb-12">
                ...
                <p className="text-sm mt-4 text-gray-800">Don't have an account <a href="javascript:void(0);" className="text-primary font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
              </div>
              <div>
          ...
          <div className="w-full h-full flex items-center bg-[#000842] rounded-xl ">
            <img src="https://online.dlu.edu.vn/static/images/Carousel/DLU-A1.png" className="w-full h-full  object-cover rounded-xl" alt="login-image" />
          </div>
