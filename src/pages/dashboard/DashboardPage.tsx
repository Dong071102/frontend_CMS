...
import HSReport from "../herds-report/HerdsReport";
    ...
    const header = (
        <div className="flex flex-wrap lign-items-center justify-between">
            ...
            <div className="flex gap-5">
                <div onClick={openNew} className="flex gap-1 p-2 rounded-full items-center justify-between text-white bg-[#3D6649] cursor-pointer hover:bg-green-900">
                    <FiPlus size={18} />
        ...
        <div>
            ...
            <Dialog visible={deleteProductDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Thông báo" modal footer={deleteProductDialogFooter} onHide={hideDeleteProductDialog}>
                <div className="confirmation-content flex item-center ">
                    ...
                    {product && (
                        <span className="mt-3">
                            Bạn có chắc chắn muốn xóa <b>{product.studentId}</b>?
                        </span>
                    )}
                </div>
